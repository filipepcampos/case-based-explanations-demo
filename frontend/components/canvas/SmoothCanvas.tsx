...
export function SmoothCanvas({
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 place-items-center">
      ...
      <button
        className="mt-4 mr-6 md:col-start-2 rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-black text-white dark:bg-white dark:text-black gap-2 hover:bg-[#383838] dark:hover:bg-[#ccc] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:min-w-30"
